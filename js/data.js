  ...
  hardSkills: [
    {
      ...
      size: "wide",
      skills: ["ESP32", "Arduino", "PIC16F887A", "Firebase"]
    },
    {
      icon: "sliders",
      title: "Automatisme",
      size: "normal",
      skills: ["GRAFCET", "PID", "TIA Portal"]
    },
    {
      icon: "box",
      title: "CAO & Simulation",
      size: "normal",
      skills: ["SolidWorks", "MATLAB/Simulink", "ANSYS", "Proteus", "PSIM"]
    },
    {
      icon: "code",
      title: "Programmation",
      size: "normal",
      skills: ["Python / MicroPython", "C / C++", "SQL", "VHDL", "HTML / CSS"]
    },
    {
      icon: "bolt",
      title: "Électromécanique",
      size: "wide",
      skills: ["Machines électriques", "Réseaux triphasés", "Maintenance industrielle"]
    },
    {
      icon: "layout",
      title: "Outils Bureautiques & Créatifs",
      size: "normal",
      skills: ["Word / Excel / PowerPoint", "Canva", "CapCut"]
    }
  ],
